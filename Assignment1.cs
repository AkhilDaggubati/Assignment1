    ...
    class Program
    {
        ...
        */
        ...
        private static string RemoveVowels(string s)
        {
            try
            {
                // storing output in empty string;
                String outputStr = "";
                // string with vowels 
                string vowelStr = "AEIOUaeiou";
                // input string character iteration
                for (int i = 0; i < s.Length; i++)
                {
                    // If the character is not in the vowel list, add the character to the output string
                    if (!vowelStr.Contains(s[i]))
                        outputStr += s[i];
                }
                // returns output
                return outputStr;
       ...
       */
        ...
        private static bool ArrayStringsAreEqual(string[] bulls_string1, string[] bulls_string2)
        {
            try
            {
                ...
                // using join method
                string is_1 = string.Join("", bulls_string1);
                // using join method
                string is_2 = string.Join("", bulls_string2);
        ...
        */
        ...
        private static int SumOfUnique(int[] bull_bucks)
        {
            ...
            {
                // write your code here
                // storing result in output integer
                int output = 0;

                // defining the dictionary
                Dictionary<int, int> store =
                       new Dictionary<int, int>();
                // storing key values by iterating through each input integer
                for (int i = 0; i < bull_bucks.Length; i++)
                {
                    // if key repeats then incrementing the count of value
        ...
        */
        ...
        <summary>
        Given a string bulls_string  and an integer array indices of the same sizegth.
        ...
        */
        ...
        private static string RestoreString(string bulls_string, int[] indices)
        {
            try
            {
                ...
                // iterating through the indices of input
                for (int i = 0; i < indices.Length; i++)
                {
                    // existing character is being replaced with new character and converting it into string
        ...
        */
        ...
        private static string ReversePrefix(string bulls_string6, char ch)
        {
            ...
            {
                String prefix = "";
                // defining the ind for index of first occurance of char
                int count = 0;
                ...
                //loop through input and adding all other chars of input string
